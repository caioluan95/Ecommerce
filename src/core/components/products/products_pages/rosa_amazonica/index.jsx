...
import ComboRosaAmazonica from "../../cards/promotion_cards/combo_rosa_amazonica";
import CardTopHair from "../../cards/products_cards/card_top_hair";
import CardHidroliso from "../../cards/products_cards/card_hidraliso";

export default function RosaAmazonica() {
  return (
