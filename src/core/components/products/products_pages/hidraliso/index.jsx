...
import ComboHidraliso from "../../cards/promotion_cards/combo_hidraliso";
import CardTopHair from "../../cards/products_cards/card_top_hair";
import CardRosaAmazonica from "../../cards/products_cards/card_rosa_amazonica";

export default function Hidraliso() {
  return (
    <section class="text-gray-700 body-font overflow-hidden bg-white">
      <div class="mx-2 mt-2 rounded-lg pt-20">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <Image
            src="/images/hidraliso.png"
            height={500}
            width={600}
            alt="product image"
