...
import CardHidraliso from "@/core/components/products/cards/products_cards/card_hidraliso";
import CardRosaAmazonica from "@/core/components/products/cards/products_cards/card_rosa_amazonica";
import ComboHidraliso from "@/core/components/products/cards/promotion_cards/combo_hidraliso";

export default function ComboTopHair() {
  return (
    <section class="text-gray-700 body-font overflow-hidden bg-white">
      <div class="mx-2 mt-2 rounded-lg pt-20">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <Image
            src="/images/top_hair_gummy_combo.png"
            height={500}
            width={600}
            alt="product image"
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
              Combo 3 frascos - Top Hair Gummy
            </h1>
